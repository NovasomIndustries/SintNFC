...
#ifndef INC_SINTMATE_PN532_H_
#define INC_SINTMATE_PN532_H_
...
int32_t PN532_WriteFrame(PN532* pn532, uint8_t* data, uint16_t length);
int32_t PN532_ReadFrame(PN532* pn532, uint8_t* buff, uint16_t length);
int32_t PN532_CallFunction(PN532* pn532, uint8_t command, uint8_t* response, uint16_t response_length, uint8_t* params, uint16_t params_length, uint32_t timeout);
int32_t PN532_GetFirmwareVersion(PN532* pn532, uint8_t* version);
int32_t PN532_SamConfiguration(PN532* pn532);
int32_t PN532_ReadPassiveTarget(PN532* pn532, uint8_t* response, uint8_t card_baud, uint32_t timeout);
int32_t PN532_MifareClassicAuthenticateBlock(PN532* pn532, uint8_t* uid, uint8_t uid_length, uint16_t block_number, uint16_t key_number, uint8_t* key);
int32_t PN532_MifareClassicReadBlock(PN532* pn532, uint8_t* response, uint16_t block_number);
int32_t PN532_MifareClassicWriteBlock(PN532* pn532, uint8_t* data, uint16_t block_number);
int32_t PN532_Ntag2xxReadBlock(PN532* pn532, uint8_t* response, uint16_t block_number);
int32_t PN532_Ntag2xxWriteBlock(PN532* pn532, uint8_t* data, uint16_t block_number);
int32_t PN532_ReadGpio(PN532* pn532, uint8_t* pins_state);
