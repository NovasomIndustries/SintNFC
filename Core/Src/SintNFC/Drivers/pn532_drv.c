...
/**
  ...
  */
int32_t PN532_ReadFrame(PN532* pn532, uint8_t* response, uint16_t length) {
...
/**
  ...
  */
int32_t PN532_ReadPassiveTarget(
    PN532* pn532,
    uint8_t* response,
    uint8_t card_baud,
    uint32_t timeout
...
/**
  ...
  */
int32_t PN532_MifareClassicAuthenticateBlock(
    PN532* pn532,
    uint8_t* uid,
    uint8_t uid_length,
...
uint16_t i;
	if ( uid_length >= 3 + MIFARE_UID_MAX_LENGTH + MIFARE_KEY_LENGTH )
		return 0xff;
